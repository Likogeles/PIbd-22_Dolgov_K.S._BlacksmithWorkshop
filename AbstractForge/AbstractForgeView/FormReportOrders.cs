...
namespace AbstractForgeView
{
    public partial class FormReportOrders : Form
    {
        ...
        public FormReportOrders(IReportLogic logic)
        {
            ...
            reportViewer.LocalReport.LoadReportDefinition(new FileStream("D:/Documents/Учёба/Технологии програмирования/vsProjects/Кузнечная мастерская/AbstractForge/AbstractForgeView/ReportOrders.rdlc", FileMode.Open));
            Controls.Clear();
