using AbstractForgeClientApp.Models;
...
using AbstractForgeClientApp.Models;
/*
namespace AbstractForgeClientApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ManufactureViewModel flow = APIClient.GetRequest<ManufactureViewModel>($"api/main/getmanufacture?manufactureId={manufacture}");
